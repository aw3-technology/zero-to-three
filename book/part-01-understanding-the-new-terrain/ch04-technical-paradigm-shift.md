...
> **Skim This Chapter**
> - Technology entrepreneurship has shifted from building apps to building infrastructure; success now requires mastering hardware supply chains, geopolitics, and system-level design alongside user acquisition.
> - Output: A framework for positioning your venture within the new infrastructure-centric paradigm, with case studies illustrating both triumphs and catastrophic failures.

> **Difficulty: Advanced** · Prerequisite Knowledge: Basic understanding of software architecture, cloud computing concepts, and familiarity with terms like API, protocol, and distributed systems. If you are a non-technical reader, start with the summary box below and skim the case studies — they are accessible without deep technical background.

> **Non-Technical Summary**
>
> Technology entrepreneurship has shifted from building apps to building infrastructure. Success now depends on understanding hardware supply chains, geopolitical forces, and system-level design — not just user acquisition. Key takeaways: (1) AI and Web3 are infrastructure layers, not just tools; (2) physical constraints like chips and energy still govern digital systems; (3) founders must think like stewards of systems, not just creators of products. If this chapter feels dense, focus on the case studies and the Founder's Checklist.
...
The stakes have never been higher. Founders are no longer building applications; they are creating infrastructure that will reshape economies, governance systems, and social structures. The case studies in this chapter---from sovereign AI development to cryptocurrency exchange collapse to semiconductor manufacturing---reveal the patterns that separate durable ventures from cautionary tales.
...
**Figure 4.1:** Technology Adoption Curves — Internet vs. Mobile vs. Crypto vs. AI
...
100M    │░░              ▒▒▒▒                   ▓▓▓      │
 ...
 10M    │      ▒▒▒▒▒                          ▓▓         │
  ...
  1M    │▒▒                                  ▓            │
        └────┬────┬────┬────┬────┬────┬────┬─────────────┘
         Yr 0  +5  +10  +15  +20  +25  +30
              (Years since mainstream availability)
```

*Internet: 1991 (WWW); Mobile: 2007 (iPhone); Crypto: 2013 (Ethereum); AI: 2022 (ChatGPT). Crypto adoption is measured by unique wallet addresses; AI adoption by monthly active users of generative AI tools.*

*Source: ITU World Telecommunication data; GSMA Mobile Economy reports; Chainalysis Global Crypto Adoption Index; company-reported MAU data.*
...
Unlike closed-source AI systems typical in Western markets, DeepSeek emphasizes transparency in training methodology, architecture, and evaluation. Their models' weights and architectures are publicly available, enabling academic institutions, government entities, and businesses throughout China's technology ecosystem to analyze, refine, and deploy these systems without dependency on potentially restricted Western alternatives. In January 2025, DeepSeek's R1 model briefly surpassed ChatGPT as the most downloaded free app on the iOS App Store in the United States—triggering an 18% drop in NVIDIA's share price and forcing a global reckoning with the assumption that frontier AI requires hundreds of millions in training costs. DeepSeek claimed its V3 model cost just $6 million to train, compared to over $100 million for GPT-4. By early 2026, DeepSeek continued releasing open-weight models under MIT license (V3.1, V3.2-Exp) and was preparing its multimodal V4 model.
...
Few cautionary tales in recent technology history offer as many lessons as the meteoric rise and catastrophic collapse of FTX. Founded in 2019 by Sam Bankman-Fried, the cryptocurrency exchange grew to a $32 billion valuation (January 2022) in just three years, only to implode spectacularly in November 2022 amid revelations of misappropriated customer funds, nonexistent risk controls, and fundamental corporate governance failures.
...
### From Gaming Graphics to AI Backbone
...
This transformation has been nothing short of extraordinary. By early 2026, NVIDIA's market capitalization reached $4.5 trillion (as of Q1 2026)—making it the world's most valuable company on the planet—with revenue growing over 60% year-over-year as AI infrastructure demand continues to surge. More significantly, NVIDIA has established itself as the essential infrastructure provider for AI development, with its GPUs powering everything from research labs to production deployments of the most advanced foundation models. Hyperscaler AI companies are projected to spend $527 billion on compute infrastructure in 2026 alone (Goldman Sachs estimate, Q1 2026), much of it flowing through NVIDIA's ecosystem.
...
This specialization strategy has made TSMC the world's most advanced semiconductor manufacturer, producing chips for companies like Apple, AMD, NVIDIA, and Qualcomm. More significantly, TSMC has achieved near-monopoly status in leading-edge semiconductor manufacturing, commanding over 70% of the global foundry market by revenue (with the next competitor, Samsung, holding just 8%, as of Q3 2025) and an even more dominant position in the most advanced process nodes.
...
- **Chip War: The Fight for the World's Most Critical Technology** by Chris Miller — The definitive account of the semiconductor industry's geopolitical importance, essential context for understanding hardware supply chain dynamics.
- **The Age of AI: And Our Human Future** by Henry Kissinger, Eric Schmidt, and Daniel Huttenlocher — Examines AI as an infrastructure-level shift in civilization, connecting technical paradigm change to governance and geopolitics.
- **Mastering Ethereum** by Andreas M. Antonopoulos and Gavin Wood — The technical reference for understanding Ethereum's protocol-layer architecture and the infrastructure design principles that apply across Web3.
- **Designing Data-Intensive Applications** by Martin Kleppmann — A practitioner's guide to the distributed systems engineering that underpins both AI infrastructure and blockchain networks.

## Sources

### Books and Industry Analysis
1. Huang, Jensen. NVIDIA earnings calls and investor presentations, 2020-2025. NVIDIA market capitalization data via CompaniesMarketCap, March 2026.
...
6. Goldman Sachs. "Why AI Companies May Invest More than $500 Billion in 2026." Goldman Sachs Insights, 2026.
7. TrendForce. "TSMC's Market Share Hits 70%." TrendForce Press Center, September 2025.
...
3. DeepSeek Technical Reports and Model Cards. deepseek.com, 2023-2026. DeepSeek R1 release, January 2025; V3.1 (MIT License), August 2025; V4 (multimodal), March 2026.
4. OpenAI GPT-4 Technical Report. OpenAI, 2023. OpenAI $110B Series at $840B post-money valuation, February 2026 (CNBC, TechCrunch).
...
1. FTX bankruptcy court filings and examiner reports, 2022-2024.
2. Federal Reserve Economic Data on interest rates and monetary policy, 2010-2026.
3. Venture capital industry reports from PitchBook, CB Insights on funding trends. AI captured ~50% of all global VC funding in 2025 ($202B+) (per Crunchbase, January 2026).
4. Cryptocurrency market analysis from various industry sources. 560M+ global crypto holders (as of early 2025, per CoinLaw 2026 report).
5. TSMC and semiconductor industry financial reports and analyst coverage, including record quarterly revenue of $30.24B (Q2 2025).

### Geopolitical and Supply Chain
1. U.S. CHIPS and Science Act documentation and analysis, 2022-2025.
2. Taiwan-China relations impact on semiconductor supply chains - academic and policy analysis.
3. Export control regulations on advanced semiconductors - U.S. Commerce Department, updated 2025.
4. China's AI and semiconductor development strategies - government policy documents. DeepSeek as case study of efficiency-driven sovereign AI (January 2025 market disruption).
...
1. "The AI Boom and Its Infrastructure Requirements." *The Information*, various articles 2023-2026.
2. "FTX Collapse: Timeline and Analysis." *Financial Times*, November 2022 - ongoing.
3. "Global Semiconductor Competition." *The Economist*, various articles 2022-2026.
4. Technology industry coverage from *TechCrunch*, *Ars Technica*, *Wired*. Includes Anthropic $30B Series G at $380B valuation (CNBC, February 2026) and OpenAI $110B raise (TechCrunch, February 2026).
5. Cryptocurrency and DeFi analysis from *CoinDesk*, *The Block*, *DeFi Pulse*.

---

**Previously:** [Chapter 03: Timeless Wisdom from Zero to One](ch03-timeless-wisdom-from-zero-to-one.md) — Revisited Thiel's enduring principles on monopoly, secrets, and contrarian thinking, adapting them for the AI and Web3 era.

**Next:** [Chapter 05: Economic Fundamentals](ch05-economic-fundamentals.md) — Covers the economic realities every founder must master, from unit economics and scarcity to capital structures and stress-testing survivability.
