# Chapter 29: Technology Decisions

> *Last Updated: March 2026*

> **Skim This Chapter**
> - Evaluate technology choices across five dimensions (technical fit, ecosystem health, business alignment, risk management, team capability) using Architecture Decision Records
> - Output: A decision matrix, ADR templates, and cost planning worksheets for making and documenting technology choices systematically

## In This Chapter, You Will

- Learn a five-dimension framework for evaluating technology choices systematically
- Apply Architecture Decision Records to document and communicate technical decisions
- Identify common technology decision anti-patterns before they become costly
- Evaluate Web3 and AI-specific technology trade-offs with concrete reference architectures
...
```mermaid
graph TD
    A[Technology Decision Needed] --> B[Score on 5 Dimensions]
    B --> C{Technical Fit - 25%}
    B --> D{Ecosystem Health - 20%}
    B --> E{Business Alignment - 20%}
    B --> F{Risk Management - 20%}
    B --> G{Team Capability - 15%}
    ...
    H --> I{Score > Threshold?}
    I -->|Yes| J[Write ADR]
    I -->|No| K[Evaluate Alternatives]
    K --> B
    J --> L[Implement with SLOs]
    L --> M[Measure and Review Quarterly]
...
- [ ] Have we documented our major technology decisions using Architecture Decision Records?
- [ ] Does each technology choice score well across all five dimensions of the decision matrix?
- [ ] Have we identified and mitigated vendor lock-in risks in our current stack?
- [ ] Do we have a technology cost planning worksheet tracking projected vs. actual costs?
- [ ] Are our SLOs defined and appropriate for our current venture stage?

## Exercises

1. **Technology Decision Audit**: List your five most significant technology choices. For each, score it across the five decision matrix dimensions (Technical Fit, Ecosystem Health, Business Alignment, Risk Management, Team Capability). Identify the weakest score and develop a mitigation plan.

2. **ADR Writing Sprint**: Select a pending technology decision and write a complete Architecture Decision Record. Include context, the decision, consequences, and at least three alternatives considered. Share it with your team for review.

3. **Anti-Pattern Detection**: Review your current technology stack against the common anti-patterns discussed in this chapter. Identify any active anti-patterns and create a prioritized plan to address the most impactful one within the next quarter.
...
- **Designing Data-Intensive Applications** by Martin Kleppmann — The definitive guide to the principles and trade-offs behind modern data systems, essential for making informed technology stack decisions.
- **Technology Strategy Patterns** by Eben Hewitt — A practical framework for aligning technology choices with business strategy, covering architecture decision-making at the organizational level.
- **Building Microservices** by Sam Newman — Explores the architectural patterns, trade-offs, and organizational implications of distributed systems design for growing engineering teams.
- **The Architecture of Open Source Applications** edited by Amy Brown and Greg Wilson — Real-world case studies of how successful software projects made their architectural decisions and what they learned.
- **A Philosophy of Software Design** by John Ousterhout — Focuses on managing complexity in software systems, offering principles directly applicable to technology stack evaluation and selection.

## Sources

1. Kleppmann, M. (2017). *Designing Data-Intensive Applications*. O'Reilly Media.
2. Hewitt, E. (2018). *Technology Strategy Patterns: Architecture as Strategy*. O'Reilly Media.
3. Newman, S. (2021). *Building Microservices: Designing Fine-Grained Systems* (2nd ed.). O'Reilly Media.
4. Brown, A. & Wilson, G. (Eds.). (2012). *The Architecture of Open Source Applications*. Lulu.com.
5. Ousterhout, J. (2018). *A Philosophy of Software Design*. Yaknyam Press.
...
**Previously:** [Chapter 24: System Thinking](ch24-system-thinking.md) — Framed ventures as interconnected systems of feedback loops, delays, and incentives, showing how to find leverage points for outsized change.

**Next:** [Chapter 26: Understanding User Adoption](ch26-user-experience.md) — Decodes the psychology behind technology adoption, exploring why users choose products based on identity, emotion, and social context rather than features alone.
