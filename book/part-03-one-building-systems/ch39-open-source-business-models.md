# Chapter 39: Open-Source Business Models
...
Hugging Face, founded in 2016 as a chatbot company, pivoted to become the central hub for open-source AI and machine learning. By September 2025, the company had raised roughly $3.2 billion in total funding---including a $2 billion round at a $13.5 billion valuation---making it one of the most valuable open-source companies in the AI ecosystem. Revenue reached approximately $130 million in 2024, nearly doubling from the prior year. Its trajectory illustrates a distinctive business model that combines elements of SaaS, marketplace, and managed services into something genuinely novel: a community platform for AI.
...
By October 2025, n8n had raised $240 million in total venture capital---including a $180 million Series C backed by Accel, NVIDIA's NVentures, and Sequoia---at a $2.5 billion valuation, demonstrating that open-core companies outside Silicon Valley can attract significant investment when the business model is sound and the market opportunity is clear. Annual recurring revenue surpassed $40 million, with usage growing 10x year-over-year. The community around n8n grew to include over 40,000 members who contributed integrations, shared workflows, and provided mutual support, creating the community effects that reduce support costs and accelerate product improvement.
