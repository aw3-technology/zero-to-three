...
**Previously:** [Chapter 35: Operational Excellence](../part-04-two-scaling-systems/ch35-operational-excellence.md) — Covered how to design operations for ten-times growth through process redesign, measurement, and self-correcting systems rather than heroic management.

**Next:** [Chapter 37: Future Paradigms](ch37-future-paradigms.md) — Looks ahead to emerging paradigm shifts including the autonomous economy, cognitive infrastructure, and how system leaders can recognize and shape these transformations.
